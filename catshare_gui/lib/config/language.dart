...
String appText(AppLanguage language, String key) {
  const values = {
    'en': {
      ...
      'quickSaveDestinationHint': 'Automatically save incoming files to',
      ...
      'found': 'found',
      'files': 'files',
      'receiveActive': 'Ready to receive',
      'receivePaused': 'Receiving paused',
      'receiveHint':
          'Other devices can send files to this PC while OSharePC is open.',
    ...
    'zh-CN': {
      ...
      'quickSaveDestinationHint': '自动将传入文件保存到',
      ...
      'receiveActive': '已准备接收',
      'receivePaused': '接收已暂停',
      'receiveHint': 'OSharePC 打开时，其他设备可以向此电脑发送文件。',
      'transferring': '正在传输文件……',
      'receiving': '正在接收……',
    ...
    'zh-TW': {
      ...
      'quickSaveDestinationHint': '自動將傳入檔案儲存至',
      ...
      'receiveActive': '已準備接收',
      'receivePaused': '接收已暫停',
      'receiveHint': 'OSharePC 開啟時，其他裝置可以向此電腦傳送檔案。',
      'transferring': '正在傳送檔案……',
      'receiving': '正在接收……',
