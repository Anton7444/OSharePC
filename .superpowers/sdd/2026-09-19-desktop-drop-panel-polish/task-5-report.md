...
Only the Task 5 panel, presentation helper, localization, and transfer tests were changed; unrelated dirty files were preserved. Commit: `b22fc16 feat: show desktop transfer progress and ETA`.
